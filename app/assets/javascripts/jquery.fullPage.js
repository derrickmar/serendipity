...
(function($) {
    $.fn.fullpage = function(options) {
        ...
        $.fn.fullpage.printOptions = function() {
        	return options;
        }

        /** Derrick's custom function. */
        $.fn.fullpage.setElementToNormalScroll = function(value) {
            if (options.normalScrollElements == null) {
           		 options.normalScrollElements = value;
           		 checkParentForNormalScrollElement($(value));
            } else {
         	   options.normalScrollElements = options.normalScrollElements + ', ' + value;
            }
            return true;
        };
